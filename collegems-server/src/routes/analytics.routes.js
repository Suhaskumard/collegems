...
import { getTeacherDashboardMetrics } from "../controllers/teacherAnalytics.controller.js";
import { cache } from "../utils/cache.js";

const router = express.Router();

// GET /api/analytics/teacher/dashboard
// Retrieves analytics for Teacher dashboard
router.get("/teacher/dashboard", restrictTo("teacher", "hod", "admin"), getTeacherDashboardMetrics);
